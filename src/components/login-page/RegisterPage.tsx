        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center h-32 rounded-full mb-2">
              <img src={logo} alt="Logo" className="h-32 mx-auto rounded-full object-cover" />
            </div>
            <h1 className="text-primary mb-2 font-extrabold text-xl uppercase">Đăng ký tài khoản</h1>
          </div>
